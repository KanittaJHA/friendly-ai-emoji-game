          ...
          {gameState === "idle" && (
            <div className="bg-purple-dark text-white rounded-2xl p-4 mt-auto shadow-sm">
              ...
              <ul className="text-sm space-y-1 opacity-90">
                <li>1. กดปุ่ม "เริ่มเกม" เพื่อเริ่มต้น</li>
                <li>2. ดู Emoji และทำท่าเลียนแบบ</li>
                <li>3. กดถ่ายรูปหรือรอให้เวลาหมด</li>
                <li>4. AI จะให้คะแนนตามความเหมือน</li>
                <li>5. เล่น 5 รอบเพื่อรับคะแนนรวม</li>
              </ul>
            </div>
          )}
        </div>
